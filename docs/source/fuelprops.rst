...
`fuel/refCompounds.csv <https://github.com/NatLabRockies/FuelLib/blob/main/fuel/refCompounds.csv>`_ file,
with associated functional group decompositions in `fuel/groupDecompositionData/refCompounds.csv <https://github.com/NatLabRockies/FuelLib/blob/main/fuel/groupDecompositionData/refCompounds.csv>`_.
...
.. csv-table:: Reference compounds, chemical formulas, and corresponding PelePhysics keys by GCxGC bin.
   :file: ../fuellib/data/fuel/refCompounds.csv
   :header-rows: 1
   :align: center
   :widths: auto
